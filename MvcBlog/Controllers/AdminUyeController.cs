...
namespace MvcBlog.Controllers
{
    public class AdminUyeController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Uyeid,KullaniciAdi,Mail,AdSoyad,YetkiID,Sifre")] Uye uye)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Uyeid,KullaniciAdi,Mail,AdSoyad,YetkiID,Sifre")] Uye uye)
        {
            if (ModelState.IsValid)
            {
